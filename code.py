...
main = tkinter.Tk()
main.title(" Detection of Thyroid Disorders using Machine Learning Approach") 
...
font = ('times', 16, 'bold')
title = Label(main, text='Detection of Thyroid Disorders using Machine Learning Approach')
